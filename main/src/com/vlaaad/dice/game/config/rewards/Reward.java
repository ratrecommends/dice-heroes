...
public abstract class Reward {
    ...
    final Reward doInit(HashMap<String, Object> data) {
        init(data);
        return this;
    }

    protected abstract void init(HashMap<String, Object> data);

    public abstract RewardResult apply(UserData userData);
