 ...
 */
public class AiShamanTurnProcessor extends AiDefaultTurnProcessor {
    private static final Vector2 tmp1 = new Vector2();

    @Override public float getValue(Creature creature, int x, int y) {
        return getShamanValue(creature, x, y);
    }

    public static float getShamanValue(Creature creature, int x, int y) {
