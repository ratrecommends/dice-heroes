 ...
 */
public class AiClericTurnProcessor extends AiDefaultTurnProcessor {
    private static final Vector2 tmp1 = new Vector2();

    @Override public float getValue(Creature creature, int x, int y) {
        return getClericValue(creature, x, y);
    }

    public static float getClericValue(Creature creature, int x, int y) {
        ...
        int canAttackCount = Shot.findTargets(
            creature,
