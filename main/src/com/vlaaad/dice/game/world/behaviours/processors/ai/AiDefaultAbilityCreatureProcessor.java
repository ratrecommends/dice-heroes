 ...
 */
public class AiDefaultAbilityCreatureProcessor extends RequestProcessor<Creature, AbilityCreatureParams> {
    ...
    @Override public IFuture<Creature> process(AbilityCreatureParams params) {
        ...
        return Future.completed(params.creature.world.getController(RandomController.class).random(params.available));
    }
}
