 ...
 */
public class BerserkProcessor extends AiDefaultProfessionAbilityProcessor {
    public BerserkProcessor() {
        super("warrior", "berserk");
    }

    @Override protected int preProcess(Creature creature, Ability ability) {
        Array<Creature> targets = Attack.findTargets(creature, creature.world);
        if (targets.size == 0)
            return -1;
        return 2;
    }
