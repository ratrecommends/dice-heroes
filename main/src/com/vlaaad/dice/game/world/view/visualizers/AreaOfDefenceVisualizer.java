 ...
 */
public class AreaOfDefenceVisualizer implements IVisualizer<AreaOfDefenceResult> {

    private final ResultVisualizer visualizer;

    public AreaOfDefenceVisualizer(ResultVisualizer visualizer) {
        this.visualizer = visualizer;
    }

    @Override public IFuture<Void> visualize(final AreaOfDefenceResult result) {
