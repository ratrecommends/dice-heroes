 ...
 */
public class ForceDragDieOnSpawn extends ForceDragActor {
    private final String dieName;

    public ForceDragDieOnSpawn(String dieName) {
        super();
    ...
    @Override protected Actor getActor() {
        ...
        return playState.world.getController(SpawnController.class).getDieIconToSpawn(die);
    }

    @Override protected Rectangle[] getTargets() {
        PvePlayState playState = resources.get("playState");
        return playState.world.getController(ViewController.class).getSpawnTargets();
    }
}
