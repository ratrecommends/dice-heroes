 ...
 */
public class ShowTutorialArrowOnDieSkills extends ShowTutorialArrow {

    private final String dieName;

    public ShowTutorialArrowOnDieSkills(String dieName) {super();
    ...
    @Override protected Actor getTarget() {
        ...
        return mapState.diceWindow.getPane(die).skillLabel;
    }
