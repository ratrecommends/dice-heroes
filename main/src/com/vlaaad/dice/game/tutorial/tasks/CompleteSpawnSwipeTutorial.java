...
/**
 * Created 09.08.14 by vlaaad
 */
public class CompleteSpawnSwipeTutorial extends TutorialTask {
    @Override public void start(Callback callback) {
        TutorialProvider provider = resources.get("tutorial-provider");
        provider.completeSpawnSwipeTutorial();
        callback.taskEnded();
    }
}
