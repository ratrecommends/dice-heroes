...
import com.vlaaad.common.tutorial.OneShotTask;
 ...
 */
public class PauseRoundController extends OneShotTask {

    @Override protected void execute() {
        PvePlayState playState = resources.get("playState");
        playState.world.getController(RoundController.class).pause();
    }
}
