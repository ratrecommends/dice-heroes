 ...
 */
public class ShowTutorialArrowOnStartButton extends ShowTutorialArrow {
    @Override protected Actor getTarget() {
        PvePlayState playState = resources.get("playState");
        return playState.world.getController(SpawnController.class).startButton;
    }

    @Override protected float getArrowOffset() {
        PvePlayState playState = resources.get("playState");
        return playState.world.getController(SpawnController.class).startButton.getPrefHeight() * 2 + 8;
    }
