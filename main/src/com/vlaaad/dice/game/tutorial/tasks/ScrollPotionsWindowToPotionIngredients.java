 ...
 */
public class ScrollPotionsWindowToPotionIngredients extends TutorialTask {
    @Override public void start(final Callback callback) {
        GameMapState state = resources.get("state");
        state.potionsWindow.scrollTo(state.potionsWindow.ingredientsTable, new Runnable() {
