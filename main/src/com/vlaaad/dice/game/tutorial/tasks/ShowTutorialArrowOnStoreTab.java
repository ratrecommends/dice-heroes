 ...
 */
public class ShowTutorialArrowOnStoreTab extends ShowTutorialArrow {
    private final String dieName;

    public ShowTutorialArrowOnStoreTab(String dieName) {
    ...
    @Override protected Actor getTarget() {
        ...
        return mapState.diceWindow.getPane(die).storeTabHeader;
    }
