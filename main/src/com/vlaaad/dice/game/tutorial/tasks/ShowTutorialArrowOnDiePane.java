 ...
 */
public class ShowTutorialArrowOnDiePane extends ShowTutorialArrow {
    private final String dieName;

    public ShowTutorialArrowOnDiePane(String dieName) {
        super();
    ...
    @Override protected Actor getTarget() {
        ...
        return mapState.diceWindow.getPane(die).info;
    }
