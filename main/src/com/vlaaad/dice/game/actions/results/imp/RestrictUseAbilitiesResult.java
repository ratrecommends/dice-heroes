...
public class RestrictUseAbilitiesResult implements IActionResult, ITargetOwner {
    ...
    public final ModifierEffect<Boolean> effect;

    public RestrictUseAbilitiesResult(Ability ability, Creature creature, Creature target, int turnCount) {
        this.ability = ability;
        this.creature = creature;
        this.target = target;
        this.turnCount = turnCount;
        this.effect = new ModifierEffect<Boolean>(
            ability,
            Attribute.canUseProfessionAbilities,
            new Set<Boolean>(Boolean.FALSE, 10),
            turnCount,
