 ...
 */
public class TurnEndedResult implements ITargetOwner, IActionResult {
    public final Ability ability;
    public final Creature creature;

    public TurnEndedResult(Ability ability, Creature creature) {
        this.ability = ability;
        this.creature = creature;
    }

    @Override public void apply(World world) {
        creature.set(Attribute.actionPoints, 0);
    }
