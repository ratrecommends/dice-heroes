 ...
 */
public class AntidoteResult implements ITargetOwner, IActionResult {
    public final Ability ability;
    public final Creature creature;
    public final Creature target;

    public AntidoteResult(Ability ability, Creature creature, Creature target) {
    ...
    @Override public void apply(World world) {
        target.set(Attribute.poisoned, Boolean.FALSE);
