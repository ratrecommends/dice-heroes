 ...
 */
public class AddEffect implements ITargetOwner, IActionResult, IAbilityOwner {
    public final Ability ability;
    public final Creature creatureToAddEffect;
    public final CreatureEffect effectToApply;

    public AddEffect(Ability ability, Creature creatureToAddEffect, CreatureEffect effectToApply) {
        this.ability = ability;
        this.creatureToAddEffect = creatureToAddEffect;
        this.effectToApply = effectToApply;
    }

    @Override public void apply(World world) {
        creatureToAddEffect.addEffect(effectToApply);
    }

    @Override public Creature getTarget() {
        return creatureToAddEffect;
    }
