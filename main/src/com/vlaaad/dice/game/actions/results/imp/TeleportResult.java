 ...
 */
public class TeleportResult implements ITargetOwner, IActionResult {
    public final Ability ability;
    public final Creature creature;
    public final Grid2D.Coordinate coordinate;

    public TeleportResult(Ability ability, Creature creature, Grid2D.Coordinate coordinate) {
    ...
    @Override public void apply(World world) {
        creature.removeEffect("viscosity");
        world.move(creature, coordinate.x(), coordinate.y());
    }
