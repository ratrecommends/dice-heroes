 ...
 */
public class RandomTeleportSelf extends TeleportSelf {
    public RandomTeleportSelf(Ability owner) {
        super(owner);
    }
    ...
    @Override public IFuture<? extends IActionResult> apply(final Creature creature, World world) {
        ...
        return Future.completed(calcResult(creature, world.getController(RandomController.class).random(coordinates)));
    }
}
